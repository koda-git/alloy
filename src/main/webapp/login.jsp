    ...
    <div class="w-[602px] h-[472px]">
      <form action="Login" method="post">
        <div class="w-[600px] h-[98px]">
          <p class="absolute left-[92px] top-[302px] text-xl font-medium text-left text-[#4d5959]"> Email </p>
        ...
        <div class="w-[600px] h-[99px]">
          <p class="absolute left-[94px] top-[424px] text-xl font-medium text-left text-[#4d5959]"> Password </p>
          <div class="w-[600px] h-[65px]">
