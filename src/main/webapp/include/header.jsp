...
>
    ...
    >
        <div
                class="flex justify-center items-center flex-grow-0 flex-shrink-0 relative gap-2.5 p-2.5 rounded-[100px] bg-white"
                style="box-shadow: 0px 2px 5px 0 rgba(38,51,77,0.03);"
        >
            <svg
                    width="30"
                    height="31"
        ...
        <p class="flex-grow-0 flex-shrink-0 text-lg font-bold text-left text-[#4d5e80]">
        </p>
    </div>
    <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 gap-[30px]">
        <div class="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-[15px]">
            ...
            <p class="flex-grow-0 flex-shrink-0 text-[13px] font-bold text-left text-[#6b7a99]">
        ...
        <div class="flex justify-start items-start flex-grow-0 flex-shrink-0 gap-2.5">
            <div class="flex justify-start items-start flex-grow-0 flex-shrink-0 relative">
                ...
                <div
                        class="flex-grow-0 flex-shrink-0 w-2.5 h-2.5 absolute left-10 top-0 rounded-[100px] bg-[#e62e7b]"
                        style="box-shadow: 0px 2px 10px 0 rgba(38,51,77,0.03);"
                ></div>
            </div>
            <div
                    class="flex justify-center items-center flex-grow-0 flex-shrink-0 relative gap-2.5 p-2.5 rounded-[100px] bg-white"
